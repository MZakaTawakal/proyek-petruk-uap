...
Territory* createSampleWorld(queue<Territory*>& wilayahQueue) {    
    int a, b;
    cout<<"Selamat datang di program divide and conquer wilayah"<<endl;
    cout<<"Disini Anda mengendalikan sebuah kerajaan yang akan menaklukan berbagai daerah"<<endl;
    cout<<"Masukkan jumlah populasi kerajaan Anda"<<endl;
    cin>>a;
    cout<<"Masukkan tingkat kekuatan kerajaan Anda"<<endl;
    cin>>b;
